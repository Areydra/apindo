...
@include('layouts.admin.sidebar')
  <div class="content-wrapper">
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title text-center">Edit Artikel</h4>
          <hr>
          @if(session('status'))
          ...
          @endif
          <form class="forms-sample" method="POST" action="{{ route('artikel_update', $data->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputName1" placeholder="judul" name="judul" value="{{ $data->judul }}">
            </div>
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="exampleSelectGender" name="kategori">
                    <option selected value="{{ $data->kategori }}" hidden>{{ $data->kategori }}</option>
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" id="mytextarea" style="height: 450px" name="artikel">{!! $data->artikel !!}</textarea>
            </div>
            <button type="submit" class="btn btn-gradient-primary mr-2">Edit</button>
            <a href="{{ route('artikel') }}" class="btn btn-light">Halaman Data Artikel</a>
          </form>
        </div>
      </div>
    </div>
