...
@include('layouts.admin.sidebar')
  <div class="content" style="width: 100%">
    <div class="col-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Tambah Pelatihan Seminar Apindo DPK Jaktim</h4><hr>
          @if(session('status'))
            <div class="alert alert-success" style="background-color: #1bcfb4">
              <p style="color: white">{{ session('status') }}</p>
            </div>
          @endif
          <form class="forms-sample" method="POST" action="{{ route('pelatihan_seminar_store') }}">
            @csrf
            <div class="row">
              <div class="col-lg-6">
                @if ($errors->has('topik'))
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputName1" placeholder="" name="topik" value="{{ old('topik') }}">
                </div>
              </div>
              <div class="col-lg-6">
                @if ($errors->has('waktu'))
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputName1" placeholder="" name="waktu" value="{{ old('waktu') }}">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputName1" placeholder="" name="peserta" value="{{ old('peserta') }}">
                </div>
              </div>
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputName1" placeholder="" name="registrasi" value="{{ old('registrasi') }}">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputName1" placeholder="" name="narasumber" value="{{ old('narasumber') }}">
                </div>
              </div>
              <div class="col-lg-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="exampleInputName1" placeholder="" name="investasi" value="{{ old('investasi') }}">
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <textarea name="tempat" id="" cols="30" rows="10" class="form-control">{{ old('tempat') }}</textarea>
            </div>
